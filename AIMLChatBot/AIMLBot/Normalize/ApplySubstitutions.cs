...
{
    public class ApplySubstitutions : TextTransformation
    {
        public ApplySubstitutions(AIMLBot bot, string inputString)
            : base(bot, inputString)
        { }

        public ApplySubstitutions(AIMLBot bot)
            : base(bot)
        { }
        ...
        public static string Substitute(AIMLBot bot, SettingsDictionary dictionary, string target)
        {
